...
def by_knn_plot(df, result_df, current_out, graph_type, group_by):
    return _build_box_hist_plot(df, result_df, graph_type, group_by)


def by_simple_imputer_plot(df, result_df, current_out, graph_type, group_by):
    return _build_box_hist_plot(df, result_df, graph_type, group_by)


def by_min_per_sample_plot(df, result_df, current_out, graph_type, group_by):
    return _build_box_hist_plot(df, result_df, graph_type, group_by)


def by_min_per_protein_plot(df, result_df, current_out, graph_type, group_by):
    return _build_box_hist_plot(df, result_df, graph_type, group_by)


def by_min_per_dataset_plot(df, result_df, current_out, graph_type, group_by):
    return _build_box_hist_plot(df, result_df, graph_type, group_by)
...
def _build_box_hist_plot(df, result_df, graph_type, group_by) -> list[Figure]:
    """
