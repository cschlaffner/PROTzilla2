...
class Run:
    ...
    def create(cls, run_name, workflow_config_name="standard"):
        run_path = Path(f"{BASE_DIR}/protzilla/user_data/runs/{run_name}")
    ...
    def continue_existing(cls, run_name):
        with open(f"{BASE_DIR}/user_data/runs/{run_name}/run_config.json", "r") as f:
    ...
    def __init__(self, run_name, workflow_config_name):
        ...
        with open(
            f"{BASE_DIR}/protzilla/user_data/workflows/{workflow_config_name}.json", "r"
        ) as f:
            self.workflow_config = json.load(f)

        with open(f"{BASE_DIR}/constants/workflow_meta.json", "r") as f:
