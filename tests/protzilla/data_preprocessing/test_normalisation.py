...
def test_normalisation_by_z_score(
    ...
    fig = by_z_score_plot(method_input, method_outputs, "Boxplot", "Sample","linear",[],)[0]
    if show_figures:
        fig.show()
...
def test_normalisation_by_median(
    ...
    fig = by_median_plot(method_inputs, method_outputs, "Boxplot", "Sample","linear",[])[0]
    if show_figures:
        fig.show()
...
def test_totalsum_normalisation(
    ...
    fig = by_totalsum_plot(method_inputs, method_outputs, "Boxplot", "Sample","linear",[])[0]
    if show_figures:
        fig.show()
...
def test_ref_protein_normalisation(
    ...
    fig = by_reference_protein_plot(method_input, method_outputs, "Boxplot", "Sample","linear",[])[0]
    if show_figures:
        fig.show()
