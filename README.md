...
> [!NOTE]
> For further information on how to contribute on PROTzilla read our [dev-guide](./docs/dev-guide.md) and [Project structure in the Wiki](https://github.com/cschlaffner/PROTzilla2/wiki/The-architecture-of-PROTzilla).
